...
\usepackage{cleveref}
\usepackage[backend=biber,style=numeric,sortcites=false,minnames=1,maxnames=3,maxbibnames=4]{biblatex}
\makeatletter
...
%% DEDICATION
\begin{dedication}
    % For my family and Valentin Dallerit
\end{dedication}
...
\chapter{Continuum modeling of a complex fluid with a second-order rheology}
\label{ch:4}
\input{4_chap4.tex} 
