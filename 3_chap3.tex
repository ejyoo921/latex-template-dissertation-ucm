...
\begin{itemize}
	\item We see slight instabilities on the top of the fluid domain perturbation increases. Considering a large enough fluid domain compared to the aggregate size, we hope to have the convergence of the quantities of interest near the aggregate. 
	\item To convince readers, we hereby show an aggregate's settling speed, location, and drag over time. We form an aggregate using ten cubes for the validations. 
\end{itemize}
...
\begin{figure}[ht]
	\begin{center}
		\includegraphics[scale=0.33]{./figures/fig_NC10_dt_Ua3_all}
		\includegraphics[scale=0.33]{./figures/fig_NC10_dt_C_all}
		\includegraphics[scale=0.33]{./figures/fig_NC10_dt_cm3_all}
		\includegraphics[scale=0.33]{./figures/fig_NC10_dt_Fo3_all}
