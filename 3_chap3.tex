...
%   (\ref{eq_full_force_noprime}) and (\ref{eq_total_Torque_noprime}).
...
\subsection{Laplace to Stokes kernel}
$\ \ \ \ \ $  
...
\clearpage
\subsection{Validation: Rotation around a horizontal axis}\label{validation_rot}
...
\clearpage
\subsection{Velocity comparison}
