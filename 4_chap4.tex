...
\begin{itemize}
  ...
  \item  However, due to the nonlinearity in velocity, we only could use the explicit method, which is explicit Euler method and was already available.
...
\par
We use the constitutive equation proposed by Reiner [reference] and Rivlin [reference], 
\begin{equation}
