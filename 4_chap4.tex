...
The second-order complexity form of the deviatoric stress tensor, equation (\ref{eq_CN_tau}), was introduced by Rivlin-Ericksen tensors~\cite{rivlin_stress-deformation_1955} and
